...
## Decision
- Terraform (hcloud provider) provisions one CX32-class server (4 vCPU / 8 GB), firewall, and a floating IP. Cloud-init installs k3s with Traefik and servicelb disabled.
