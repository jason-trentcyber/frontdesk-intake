...
| 0033 | Tailwind CSS v4 (official Next.js PostCSS integration) is `web/`'s styling stack; no component library; colors/spacing are Tailwind's own scale, not a bespoke token system | decided |
