...
| 0016 | Postgres: StatefulSet in the app chart, one pgvector+pgmq image for local and prod, nightly `pg_dump` to a PVC pulled to the VPS; no operator, no bucket | decided |
