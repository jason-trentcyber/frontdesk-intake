...
| 0026 | Observability on the VPS ships as Prometheus + Grafana only (node-exporter over the tailnet, no public bind, provisioned read-only dashboards); Loki and Alertmanager deferred on measured VPS memory; narrows #52 | decided, applied; Loki deferral superseded by 0039 |
